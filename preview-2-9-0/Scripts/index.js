...
function eew(){
  ...
  // ----- Narikakun API ----- //
  let url_EEW_nakn = 'https://api.narikakun.net/eew/v1.json';

  response = fetch(url_EEW_nakn)
  ...
  .then(result => {
    ...
    if(EEW_data["hypoInfo"] != null){
        ...
        // --- Is training --- //
        EEW_isTraining = result["isTraining"];

        // --- Is cansel --- //
        EEW_isCansel = result["isCancel"];
